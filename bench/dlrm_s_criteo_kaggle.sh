...
# Uncomment this to bind it to NUMA 1

# dlrm_pt_bin="numactl --membind=1 python3 dlrm_s_pytorch.py"

if [[ "$dlrm_pt_bin" == *"numactl --membind=1"* ]]; then
    echo "Running PyTorch with NUMA binding to NUMA 1..."
else
    echo "Running PyTorch without NUMA binding..."
fi
