...
# ############################################################
# bash /users/mt1370/throttle/run_freq.sh 2.4 2.4 3
...
# ############################################################
# bash /users/mt1370/throttle/run_freq.sh 2.4 2.4 1


frequencies=(3.2 2.6 2.2 1.6 1.2 0.8)  # Frequencies in GHz
...
for freq in "${frequencies[@]}"; do
    ...
    echo "# Run DLRM (NUMA 1) at ${freq}GHz CPU frequency" >> ./input/numa_memory_consumption_10GB.log
    ...
    echo "# Done running DLRM (NUMA 1) at ${freq}GHz CPU frequency" >> ./input/numa_memory_consumption_10GB.log
